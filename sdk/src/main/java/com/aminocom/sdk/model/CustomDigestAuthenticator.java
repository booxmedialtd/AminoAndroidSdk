...
public class CustomDigestAuthenticator implements CachingAuthenticator {
    ...
    public synchronized Request authenticate(Route route, Response response) {
        ...
        copyHeaderMap(headers, parameters);
    ...
    private Request authenticateWithState(Route route, Request request, Map<String, String> parameters, String cookie) {
        ...
        final NameValuePair digestHeader = createDigestHeader(credentials, userCredentials, request, parameters);
...
//    @edu.umd.cs.findbugs.annotations.SuppressFBWarnings("LSC_LITERAL_STRING_COMPARISON")
    private synchronized NameValuePair createDigestHeader(
        ...
        if (realm != null && !realm.equals("user")) {
            ...
            uname = userCredentials.getUserName();
